...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(3),m=__webpack_require__(9),p=__webpack_require__(4),v=__webpack_require__(2),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(6);
...
var _TodoListItem = __webpack_require__(53);
...
var TodoList = function (_Component) {
  ...
  _createClass(TodoList, [{
    ...
    value: function fetchTodos() {
      ...
      _axios2.default.get('/api/todoList', option).then(function (result) {
        return _this2.setState({ todos: result.data });
      }).catch(function (err) {
    ...
    value: function handleSubmit(e) {
      ...
      _axios2.default.post('/api/todoList', { name: todo, list_name: listName }).then(function () {
        return _this3.fetchTodos();
      }).catch(function (err) {
    ...
    value: function deleteTodo(todo) {
      ...
      _axios2.default.delete('/api/todoList', options).then(function () {
        return _this4.fetchTodos();
      }).catch(function (err) {
        return console.error(err);
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        todos.map(function (todo, index) {
          return _react2.default.createElement(_TodoListItem2.default, { key: index, index: index, todo: todo, deleteTodo: _this5.deleteTodo });
        })
      );
    }
  }]);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      { onClick: function onClick() {
          return props.deleteTodo(props.todo.name);
        } },
      '\u2714'
    ),
    ' ',
